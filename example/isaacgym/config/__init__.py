import os
from d2c.envs.external.isaacgym.utils.config import IsaacGymConfigBuilder
from d2c.utils.utils import abs_file_path
from example.isaacgym.config.app_config import app_config
...
def make_config(command_args=None):
    ...
    cfg_builder = IsaacGymConfigBuilder(
